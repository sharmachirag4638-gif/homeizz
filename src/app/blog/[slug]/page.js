...
const POSTS = [
  { slug:'top-interior-designers-mumbai', title:'Top 10 Interior Designers in Mumbai 2026', excerpt:'Discover the most talented and highly-rated interior designers in Mumbai. Compare portfolios and find the perfect match for your home.', time:'5 min read', img:'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80', category:'City Guide' },
  { slug:'top-architects-bangalore', title:'Best Architects in Bangalore: A Complete 2026 Guide', excerpt:'Looking for an architect in Bangalore? Here are the top firms and independent architects known for their exceptional work.', time:'6 min read', img:'https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=800&q=80', category:'City Guide' },
  { slug:'modern-vs-minimalist', title:'Modern vs Minimalist: Which Interior Style is Right for You?', excerpt:'Confused between modern and minimalist design? We break down the key differences to help you choose.', time:'7 min read', img:'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&q=80', category:'Design Guide' },
  { slug:'interior-design-cost-india', title:'How Much Does Home Interior Design Cost in India 2026?', excerpt:'A comprehensive guide to interior design costs in India. From budget to luxury, know what to expect.', time:'8 min read', img:'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80', category:'Cost Guide' },
  { slug:'vastu-shastra-modern-homes', title:'Vastu Shastra for Modern Homes: A Practical Guide', excerpt:'How to incorporate Vastu principles in your modern home design without compromising on aesthetics.', time:'6 min read', img:'https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?w=800&q=80', category:'Tips' },
  { slug:'questions-ask-interior-designer', title:'10 Questions to Ask Your Interior Designer Before Hiring', excerpt:'Make sure you are making the right choice. These key questions will help you find the perfect designer.', time:'4 min read', img:'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=800&q=80', category:'Tips' },
];
      ...
      <div style={{minHeight:'100vh',background:'var(--c)',paddingTop:64}}>
        <div style={{width:'100%',height:420,overflow:'hidden',position:'relative'}}>
          ...
          <div style={{position:'absolute',bottom:40,left:'50%',transform:'translateX(-50%)',width:'100%',maxWidth:760,padding:'0 24px'}}>
            ...
            <h1 style={{fontFamily:'var(--fd)',color:'#fff',fontSize:'clamp(1.6rem,4vw,2.6rem)',lineHeight:1.2,marginTop:16}}>{post.title}</h1>
          </div>
        </div>
        <div style={{maxWidth:760,margin:'0 auto',padding:'48px 24px 80px'}}>
          ...
          <div style={{background:'#fff',borderRadius:16,padding:'32px',border:'1.5px solid var(--borderl)',marginBottom:32}}>
            <p style={{color:'var(--tm)',lineHeight:1.85,fontSize:'.95rem'}}>
              Full article coming soon. Browse our verified professionals on Homeizz and find the perfect designer for your project.
            </p>
          </div>
