...
const SECTIONS = [
  ...
  { title: '4. Subscriptions and Payments', content: 'Professional plans are billed monthly or annually via Razorpay. During the launch offer, the first 100 professional listers may receive free launch access without entering card details at signup. Paid subscriptions renew until cancelled. You can cancel anytime from your dashboard; cancellation takes effect at the end of the current billing period.' },
