...
const SECTIONS = [
  ...
  { title: '4. Subscriptions and Payments', content: 'Professional plans are billed monthly or annually via Razorpay. The first 90 days are free for new professionals. After the trial, the selected plan auto-renews until cancelled. You can cancel anytime from your dashboard; cancellation takes effect at the end of the current billing period.' },
